...
void ConfigureADCPins(void){
	...
	ADPCFGbits.PCFG8=0; //touchscreen(analogni ulaz) za folije 
	ADPCFGbits.PCFG9=0; //touchscreen(analogni ulaz) za folije

    
    TRISBbits.TRISB6=1; //ulazni
    TRISBbits.TRISB7=1; //ulazni
	TRISBbits.TRISB8=1; // ulazni
	TRISBbits.TRISB9=1; // ulazni
...
ADCON2bits.VCFG=7;
ADCON2bits.CSCNA=1;
ADCON2bits.SMPI=3; //4 raw values - 1
ADCON2bits.BUFM=0;
ADCON2bits.ALTS=0;
